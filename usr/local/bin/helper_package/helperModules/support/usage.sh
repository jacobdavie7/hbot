...
function usage
{
    ...
    echo -e "           -v  vpn*          setup Mullvad VPN - REQUIRES ARGUMENT"
    echo -e "                   low      standard vpn config + deploy home firewall ruleset"
    echo -e "                   high    vpn config for higher risk sitiations + deploy limitedVPN firewall ruleset (port 51820)"
